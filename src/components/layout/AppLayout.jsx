...
export default function AppLayout() {
  const patientRecordMatch = useMatch('/patients/:patientId')
  const nestedPatientRecordMatch = useMatch('/patients/:patientId/*')
  const isRecord = Boolean(patientRecordMatch || nestedPatientRecordMatch)
