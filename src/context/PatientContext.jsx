...
export function PatientProvider({ children }) {
  ...
  return <PatientContext.Provider value={{ patients, refreshPatients, createPatient, addVisitToPatient, editPatient, deletePatientById, submitFeedback, saveFollowUpDraft, saveVisitNotes, saveAdrPrediction, getAdrPrediction, generateRecommendations, activeVisitId, setActiveVisitId }}>{children}</PatientContext.Provider>;
}
