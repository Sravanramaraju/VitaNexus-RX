...
export default function AdverseRiskAssessment() {
  ...
  return <section className="mx-auto max-w-5xl space-y-5">
    ...
    {["SUCCESS", "DEGRADED"].includes(state) && overall && <>
      {state === "DEGRADED" && <div className="rounded-lg border border-warning/40 bg-warning/10 p-4 text-sm"><strong>Degraded input coverage.</strong> Unrecognized inputs are shown below; the result is not presented as complete evidence.</div>}
